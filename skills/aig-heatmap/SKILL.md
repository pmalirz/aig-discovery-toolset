...
This skill aggregates scored silver-layer data from across the tracker and generates visual heatmaps, executive summaries, and prioritized roadmaps for leadership presentation. It operates on the md silver layer (structured Markdown + YAML produced by `aig-interview`) and the scorecards generated by `aig-assess`, not on raw unstructured source documents.
